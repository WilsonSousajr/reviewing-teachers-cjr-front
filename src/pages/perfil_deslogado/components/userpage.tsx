...
import UserProfileHeader from '/UnB/CJR - Github/reviewing-teachers-cjr-front/src/components/UserHeader';
import UserPost from '/UnB/CJR - Github/reviewing-teachers-cjr-front/src/components/UserPost';
